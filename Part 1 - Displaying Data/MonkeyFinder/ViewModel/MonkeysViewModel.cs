...
public partial class MonkeysViewModel : BaseViewModel
{
    ...
    [RelayCommand]
    async Task GetClosestMonkey(Monkey monkey)
    {
        ...
        try
        {
            ...
            if (location is null)
            {
                ...
                $"Could not get your location", "Ok");
                return;
            }
            ...
            await Shell.Current.DisplayAlert("Closest Monkey", $"{first.Name} in {first.Location}", "Awesome!");
        }
    ...
    async Task GetMonkeysAsync()
    {
        ...
        try
        {
            ...
            if (Monkeys.Count != 0)
                Monkeys.Clear();
            monkeys.ForEach(x => Monkeys.Add(x));
        }
        catch (Exception ex)
        {
            Debug.WriteLine(ex);
